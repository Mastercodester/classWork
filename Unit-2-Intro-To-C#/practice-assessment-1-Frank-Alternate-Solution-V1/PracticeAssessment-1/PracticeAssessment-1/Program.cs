...
// Create a static method named Subtract() that takes in 2 parameters, all doubles: num1, num2.
    ...
    */
    static string FindBuildingType(int num1)
    {
        ...
        // a switch is alternative to a seriers of if-else statements
        ...
        switch (num1)
        {
            case int house when house <= 3:// assign the value in num1 ro new int house then check house <= 3
            {
            ...
            {
                return "This is a Superskyscraper";
            }
        }
