...
---show everyone name and address
-- only if the address is known


select gambler_name as Name, address as Address 
from gambler 
...
--
--
--Show me gamblers with m in there name
--
select gambler_name
from gambler
...
select distinct casino_name -- distinct will only show unique values in the column
from host					-- distinct will also sort in asc by the column specified
;