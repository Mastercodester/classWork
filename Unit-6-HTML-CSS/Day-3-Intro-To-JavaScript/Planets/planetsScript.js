...
let planet = [Mercury, Venus, Earth, Mars, Jupiter, Saturn,Uranus, Neptune]; // let is used for variables that can change Displays the elemenst separated by a comma
console.log(`This is a value in array is: ${planet}`);
console.log(planet); // Display the array in a drop-down format in the console

console.table(planet); // Display the array in a table format in the console
get
